...
The `c0fmt` command-line tool (import/export CSV, JSON, YAML; pretty and
compact forms; validation) lives in its own repository:
https://github.com/c0data/c0-fmt. It is built on this library.
